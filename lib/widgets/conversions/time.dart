...
class _TimeUnitConverterState extends State<TimeUnitConverter> {
  ...
  void convert(String text) {
    ...
    // Conversion logic (example: converting fromValue in seconds to all other units)
    double toMicroseconds = fromValue * secondsToMicroseconds;
    double toMilliseconds = fromValue * secondsToMilliseconds;
    double toMinutes = fromValue * secondsToMinutes;
    double toHours = fromValue * secondsToHours;
    double toDays = fromValue * secondsToDays;
    double toWeeks = fromValue * secondsToWeeks;
    double toYears = fromValue * secondsToYears;
